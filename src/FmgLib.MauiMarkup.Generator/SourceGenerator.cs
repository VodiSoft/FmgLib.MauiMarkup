...
public sealed class SourceGenerator : IIncrementalGenerator
{
    ...
    private static bool TryCreateAttachedModel(AttributeData attributeData, out AttachedModel attachedModel)
    {
        ...
        attachedModel = new AttachedModel
        {
            ...
            ReturnTypeName = returnType.ToQualifiedName(),
            DeclaringTypeName = declaringType.ToQualifiedName(),
...
internal sealed class MauiMarkupAttribute : global::System.Attribute
{
    /// <summary>
    /// Initializes a new instance of the MauiMarkupAttribute class.
    /// </summary>
    /// <param name=""nativeControlTypes"">The target control types.</param>
    public MauiMarkupAttribute(params global::System.Type[] nativeControlTypes) { }
}
...
[global::System.AttributeUsage(global::System.AttributeTargets.Class, AllowMultiple = true)]
internal sealed class MauiMarkupAttachedPropAttribute : global::System.Attribute
{
    /// <summary>
    ...
    public MauiMarkupAttachedPropAttribute(global::System.Type controlType, string propertyName, global::System.Type returnType, global::System.Type declaringType) { }
}
